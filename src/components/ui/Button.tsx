...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-primary text-primary-fg hover:bg-primary-dark active:bg-primary-dark focus:ring-primary',
    secondary: 'bg-secondary text-secondary-fg hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
    outline: 'border border-border-primary text-text-primary bg-transparent hover:bg-gray-50 active:bg-gray-100 focus:ring-gray-300',
    ghost: 'text-text-primary bg-transparent hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-300',
    danger: 'bg-global-6 text-white hover:bg-red-700 active:bg-red-800 focus:ring-red-500'
  };
